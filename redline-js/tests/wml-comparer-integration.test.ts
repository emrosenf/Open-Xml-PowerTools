...
import { compareDocuments, countDocumentRevisions } from '../src/wml/wml-comparer';
...
describe('WmlComparer Test Cases', () => {
  // WC-1000: Basic text comparison (WC001-Digits)
  it('WC-1000: handles basic text comparison', async () => {
    ...
    // Expected: 4 revisions (2 insertions, 2 deletions - based on C# test)
