...
namespace OpenXmlPowerTools
{
    ...
    public static class PresentationBuilder
    {
        ...
        private static XElement CreatedEmbeddedFontPart(PresentationDocument sourceDocument, PresentationDocument newDocument, XElement font, XName fontXName)
        {
            ...
            // SDK 3.x: FontPartType is now a static class with PartTypeInfo fields
            PartTypeInfo fpt;
            ...
            foreach (XElement dataReference in newChart.GetXDocument().Descendants(C.externalData))
            {
                ...
                if (oldPartIdPair.OpenXmlPart != null)
                {
                    ...
                    if (oldEmbeddedObjectPart != null)
                    {
                        ...
                        // SDK 3.x: Use GetPackage() extension and IPackage/IPackagePart APIs
                        ...
                        fromPart.Relationships.Create(targetUri, TargetMode.Internal,
            ...
            List<ImageData> images)
        {
            ...
            else
            {
                ...
                {
                    // SDK 3.x: Use GetPackage() extension and IPackage/IPackagePart APIs
                    var pkg = newContentPart.OpenXmlPackage.GetPackage();
                    var fromPart = pkg.GetParts().FirstOrDefault(p => p.Uri == newContentPart.Uri);
                    fromPart.Relationships.Create(new Uri("NULL", UriKind.RelativeOrAbsolute), TargetMode.Internal, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/image", relId);
                }
            }
        }
